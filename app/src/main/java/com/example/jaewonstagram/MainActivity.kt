...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun uploadFile() {
        if (postPath == null || postPath == "") {
            ...
            val call = RetrofitHelper().getPictureAPI().uploadPicture("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2MjQwMjAwNDUsImlhdCI6MTYyMzkzMzY0MCwic3ViIjoyfQ.oT7zovTd86HPMqLV9U6AYADiqAojCGpXD0bT-PU4b8c", body)
            call.enqueue(object : Callback<UploadPictureResponse> {
                override fun onResponse(call: Call<UploadPictureResponse>, response: Response<UploadPictureResponse>) {
                    ...
                    if (response.isSuccessful) {
                        if (response.body() != null) {
                            ...
                            Toast.makeText(applicationContext, serverResponse.image, Toast.LENGTH_SHORT).show()
